  ...
  _createClass(PageTransition, [{
    ...
    value: function transite(nextChild) {
      ...
      return new Promise(function (transiteDone, transiteFailed) {
        var transitionActionUpper = _this3.props.history && _this3.props.history.action;
        var transitionAction = transitionActionUpper && transitionActionUpper.toLowerCase();
